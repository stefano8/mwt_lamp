...
@section('content')
    ...
    <div class="panel panel-primary" id="hidepanel1">
        ...
        <div class="panel-body">
            <form id="itineraryForm" class="form-horizontal" action=" {{url('admin/image/assign/{news_id}/saveAssignNews')}} "
                  method="get">
                <fieldset>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="id">Id</label>
                        <div class="col-md-9">
                            <input name="new_id" type="text" id="new_id" value="{{$new->id}}" class="form-control" readonly="readonly"></div>
                    </div>

                    <div class="form-group">
                        <label class="col-md-3 control-label" for="name">Title</label>
                        <div class="col-md-9">
                            <input id="name" name="name" type="text" value="{{$new->title}}" class="form-control"
