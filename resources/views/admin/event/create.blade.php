...
@section('content')
    <div class="panel panel-primary" id="hidepanel1">
        ...
        <div class="panel-body">
            <form id="eventForm" class="form-horizontal" action=" {{route('event.save')}} " method="get">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input id="address" name="address" type="text" placeholder="Address of event" class="form-control" required></div>
                    </div>
                    <div class="form-group">
