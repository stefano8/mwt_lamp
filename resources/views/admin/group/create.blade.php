...
@section('content')
    <div class="panel panel-primary" id="hidepanel1">
        ...
        <div class="panel-body">
            <form id="itineraryForm" class="form-horizontal" action=" {{route('group.save')}} " method="get">
                <fieldset>

                    <div class="form-group">
                        <label class="col-md-3 control-label" for="name">Name</label>
                        <div class="col-md-9">
                            <input id="name" name="name" type="text" placeholder="Group name" class="form-control" required></div>
                    </div>
                    <div class="form-group">
